...
<h2>Awaiting Appointments</h2>
 ...
 <tr>
	...
	$email = $_SESSION['email'];
	  $query = "SELECT a.* FROM appointment a,doctor d WHERE a.doctorId = d.id AND d.email = '$email' AND a.status = 'Awaiting'";
	 ...
	 <td><a href="confirm.php?id=<?php echo $id; ?>" >Confirm</a>
